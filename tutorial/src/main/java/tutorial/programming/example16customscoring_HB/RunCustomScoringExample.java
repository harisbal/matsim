package tutorial.programming.example16customscoring_HB;
...
public class RunCustomScoringExample {
	...
	public static void main(String[] args) {
		String configFile = "examples/tutorial/config/example16parking-config.xml" ;
		...
		for (Person person : scenario.getPopulation().getPersons().values()) {
			boolean paysParking = (boolean) person.getAttributes().getAttribute("paysparking");
